...
function TiposMovimientos(TipoIdentidad) {
    ...
    var model = {
        ...
        keyword: GlobalConstant.keywordCompraEfc,
    };
...
function SearchFinancialSummary(currentStepIndex) {
            ...
            var model = {
                ...
                idPais: GlobalConstant.BolivarName,
                idCorresp: GlobalConstant.correspCCAL,
                MonedaOperacion: $("#MonedaVenta").val(),
                OperationType: GlobalConstant.OperationTypeCompraEfc,
            ...
            GlobalApi.ExecuteSimpleAsync(GlobalVariables.SearchFinancialSummary, model, function (result) {
                ...
                $('#montoOperacion').val(result.SimbolConversion + " " + formatCurrencyVE(Math.round(result.AmmountConversionWithoutRate)));
...
function ParametrosOrden() {
    ...
    GlobalApi.ExecuteSimple(GlobalVariables.ParametrosOrden, null, function (result) {
        ...
        $.each(result, function (i, v) {
            if (v.que == GlobalConstant.MinCompEfec) {
                if (v.cuanto == null) {
                    $("#minOrden").val(100);
            ...
            if (v.que == GlobalConstant.MaxCompEfec) {
                if (v.cuanto == null) {
                    $("#maxOrden").val(300);
...
function GenerateOrden() {
    ...
    var model = {
        ...
        CodigoTipoOperacion: GlobalConstant.keywordCompraEfc,
        TasaCambio: tasa,
        ...
        if ($("#motivoOferta").val() == "" || $("#MonedaVenta").val() == "0" || $("#MonedaVenta").val() == "" || $("#montoOrden").val() == "") {
            ...
            return resultBit;
                ...
                var model = {
                    ...
                    OperationTypeId: GlobalConstant.Compra,
                };
